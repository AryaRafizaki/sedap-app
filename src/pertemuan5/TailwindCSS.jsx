    ...
    return(
        <div>
            ...
            <button className="bg-blue-500 text-white
                                ...
                                shadow-lg hover:shadow-2xs">Click Me</button>
            <Spacing/>
            <Typography/>
            <BorderRadius/>
            <BackgroundColors/>
...
function Typography(){
    return (
        <div>
            <h1 className="text-3xl font-bold text-blue-600 mx-4" >Tailwind Typography</h1>
            <p className="text-gray-600 text-lg mt-2 mx">Belajar Tailwind sangat menyenangkan dan cepat!</p>
        </div>
    )
}
...
function BackgroundColors(){
    return(
        <div className="bg-blue-500 text-white p-6 rounded-lg shadow-lg mt-8 mb-8">
